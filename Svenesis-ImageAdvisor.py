...
def generate_script(results: list[AnalysisResult]) -> str:
    ...
    lines = [
        "# Auto-generated by Svenesis Image Advisor",
...
def format_report_html(info: ImageInfo, results: list[AnalysisResult]) -> str:
    ...
    # Title
    html.append("<h2 style='color: #88aaff; margin-bottom: 4px;'>Svenesis Image Advisor — Analysis Report</h2>")
...
class ImageAdvisorWindow(QMainWindow):
    ...
    def init_ui(self) -> None:
        """Build the UI layout."""
        self.setWindowTitle(f"Svenesis Svenesis Image Advisor {VERSION}")
    ...
    def _build_left_panel(self) -> QWidget:
        ...
        # Title
        lbl = QLabel(f"Svenesis Image Advisor {VERSION}")
    ...
    def _show_coffee_dialog(self) -> None:
        ...
        dlg = QDialog(self)
        dlg.setWindowTitle("\u2615 Support Svenesis Image Advisor")
        ...
        header_msg = QLabel(
            ...
            "<b style='color:#e0e0e0;'>Enjoying the Svenesis Image Advisor?</b><br><br>"
...
def main() -> int:
    ...
    try:
        ...
        win.showMaximized()
        try:
            siril.log(f"Svenesis Image Advisor v{VERSION} loaded.")
        except Exception:
            pass
        return app.exec()
    except NoImageError:
